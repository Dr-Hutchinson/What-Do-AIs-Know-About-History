        ...
        def mary_lease():
            with col1:
                with st.form('lease_speech'):
                    ...
                    source_information = 'Source Information: The Primary Source is a speech entitled "Women in the Farmers Alliance" given by Mary Lease to the National Council of Women National Meeting in Washington D.C. (1891)'
