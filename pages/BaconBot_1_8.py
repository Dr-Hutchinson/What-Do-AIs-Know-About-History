                ...
                with st.form('Biographical Questions'):
                    ...
                    if submit_button_1:
                        ...
                        def total_output_collection():
                            d1 = {'user':["0"], 'user_id':["0"], 'model':[model_choice], 'prompt':[prompt_choice_freeform], 'prompt_boost':[prompt_boost_question_1 + "\n\n" + prompt_boost_question_2], 'question':[question], 'output':[output], 'temperature':[temperature_choice], 'response_length':[max_tokens], 'filter_ranking':[output_label], 'date':[now]}
