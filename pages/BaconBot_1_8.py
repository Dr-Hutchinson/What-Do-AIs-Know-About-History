...
def app():
    ...
    def button_one():
        ...
        def bio_questions():
            with col1:
                with st.form('Biographical Questions'):
                    ...
                    question = st.radio("Questions concerning Bacon's life and career.", ["Describe your youth and family.", "How did your education shape your later career?", "How would you describe your career in government?"])
        ...
        def court_questions():
            with col1:
                with st.form('Questions about Queen Elizabeth & King James'):
                    ...
                    question = st.radio("Questions concerning Bacon's life and career.", ["What similarities and differences do you observe in the courts of Queen Elizabeth and King James?", "How do you regard your service on the Star Chamber?", "What were the greatest domestic challenges facing England during the reigns of Elizabeth and James?", "What were the greatest foreign challenges facing England during the reigns of Elizabeth and James?"])
        ...
        with st.sidebar.form(key ='Form2'):
            field_choice = st.radio("Choose a Question Category:", ["Biographical", "Philosophy of Science", "The Courts of Queen Elizabeth & King James"])
