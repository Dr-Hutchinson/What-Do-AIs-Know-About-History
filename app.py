...
from pages import benchmarks_results, Baconbot_1_7_1, BaconBot_1_8, primary_source_analyzer, intro
...
app.add_page('2. What Does an AI "Know" About History?', benchmarks_results.app)
