...
app.add_page("2. Baconbot: An AI Simulation of Francis Bacon (Open)", BaconBot_1_8.app)
app.add_page("3. BaconBot: An AI Simulation of Francis Bacon (Limited)", Baconbot_1_7_1.app)
